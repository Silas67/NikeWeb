    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          The
          <span
            className="xl:bg-white-400 xl:whitespace-nowrap
          relative z-10 pr-10 bg-transparent"
          >
            {" "}
            New Arrival
          </span>
        ...
        <div className="flex items-start w-full mt-20 gap-16 xl:whitespace-nowrap">
          {statistics.map((stat) => (
            <div key={stat.label}>
